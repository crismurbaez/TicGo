...
const Aside = () => {
    return (
        <div className="w-full m-0 md:w-1/3 lg:w-1/3 md:mt-16 lg:mt-16  bg-orange-100 text-white shadow-2xl min-h-screen max-h-full">
            ...
            {/* diamond top */}
            <div className="inline-block items-center justify-center translate-y-10 ml-2 mr-2 rotate-45 bg-[#c5c2c2] w-[65px] h-[65px]  border-solid border-orange-100 border-8">
            </div>
