...
const Castle = () => {
    const musicOpenDoor = new Audio('/sounds/OpenDoor2.ogg');
    musicOpenDoor.load();
                ...
                <div className="w-[300px] h-[270px] bg-slate-400 flex flex-row items-end justify-center">  {/* pared del frente detrás de la puerta */}
                    ...
                    <div className="w-40 h-60 bg-white rounded-t-full"> {/* fondo que se ve al abrir la puerta */}
                        <div className="w-40 h-60 flex flex-row">  {/* puerta */}
                            <div onMouseEnter={() => handleMouseEnter()} className="w-20 h-60 bg-slate-500 rounded-tl-full border-2 border-slate-900 hover:-translate-x-4 transition duration-500 ease-in-out">  {/* hoja izquierda de la puerta */}
                            ...
                            <div onMouseEnter={() => handleMouseEnter()} className=" w-20 h-60 bg-slate-500 rounded-tr-full hover:translate-x-4 transition duration-500 ease-in-out border-2 border-slate-900">
